...
public class TextIOInfo implements Serializable {
    ...
    /** The text color of label. Defaults to theme textColorPrimary (resolved at runtime). */
    ...
    /** The text color of text. Defaults to theme textColorPrimary (resolved at runtime). */
